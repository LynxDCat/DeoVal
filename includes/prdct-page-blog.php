<section class="prdct-page-blog">
    <article class="prdct-blog-title">
        <h2>Seamless and Fast Personalized Printing Solutions</h2>
    </article>
    <section id="Product1" class="prdct-blog-1">
        <img src="images/pr-1.png" alt="Packages Image" />
        <article>
            <h1>SCHOOL | OFFICE FORMS</h1>
            <p>
            Streamline your school or office operations with 
            professionally printed forms tailored to your needs. 
            From administrative documents, student registration 
            forms, and worksheets to invoices and purchase orders, 
            we deliver high-quality, durable forms that will help your 
            team stay organized and efficient. Make your processes 
    ...
    <section id="Product3" class="prdct-blog-3">
        <img src="images/pr-3.png" alt="Placeholder Image" />
        <article>
            <h1>BROCHURE | FLYERS</h1>
            <p>
    ...
    <section id="Product5" class="prdct-blog-5">
        <img src="images/pr-5.png" alt="Placeholder Image" />
        <article>
            <h1>COMMERCIAL</h1>
            <p>
    ...
    <section id="Product7" class="prdct-blog-7">
        <img src="images/pr-7.png" alt="Placeholder Image" />
        <article>
    ...
    <section id="Product9" class="prdct-blog-9">
        <img src="images/pr-9.png" alt="Placeholder Image" />
        <article>
            <h1>CORPORATE FOLDER</h1>
            <p>
    ...
    <section id="Product11" class="prdct-blog-11">
        <img src="images/pr-11.png" alt="Placeholder Image" />
        <article>
            <h1>YEARBOOK | MAGAZINE</h1>
            <p>
    ...
    <section id="Product13" class="prdct-blog-13">
        <img src="images/pr-13.png" alt="Placeholder Image" />
        <article>
    ...
    <section id="Product15" class="prdct-blog-15">
        <img src="images/pr-15.png" alt="Placeholder Image" />
        <article>
            <h1>PACKAGING BOX</h1>
            <p>
