<section class="prdct-page-blog">
    ...
    <section class="prdct-blog-5">
        <img src="images/pr-5.png" alt="Placeholder Image" />
        <article>
            <h1>COMMERCIAL</h1>
            <p>
                High-quality and professionally crafted prints tailored to elevate
    ...
    <section class="prdct-blog-10">
        <article>
            <h1>POSTER</h1>
            <p>
                Bold, eye-catching, and impactful posters designed to stand out,
    ...
    <section class="prdct-blog-13">
        <img src="images/pr-13.png" alt="Placeholder Image" />
        <article>
            <h1>OFFSET PRINTING</h1>
            <p>
                High-volume printing services that deliver exceptional color
